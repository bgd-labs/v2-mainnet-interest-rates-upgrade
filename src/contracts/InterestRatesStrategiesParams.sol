...
library InterestRatesStrategiesParams {
  struct InterestRatesStrategyParams {
    string name;
  ...
  function getInterestRatesStrategiesParams()
    public
    pure
    returns (InterestRatesStrategyParams[] memory)
  {
    InterestRatesStrategyParams[]
      memory params = new InterestRatesStrategyParams[](18);
    address[] memory assets;

    assets = new address[](2);
    assets[0] = 0x4Fabb145d64652a948d72533023f6E7A623C7C53; // BUSD
    assets[1] = 0x57Ab1ec28D129707052df4dF418D58a2D46d5f51; // sUSD
    params[0] = InterestRatesStrategyParams({
    ...
    params[1] = InterestRatesStrategyParams({
    ...
    params[2] = InterestRatesStrategyParams({
    ...
    params[3] = InterestRatesStrategyParams({
    ...
    params[4] = InterestRatesStrategyParams({
    ...
    params[5] = InterestRatesStrategyParams({
    ...
    params[6] = InterestRatesStrategyParams({
    ...
    params[7] = InterestRatesStrategyParams({
    ...
    params[8] = InterestRatesStrategyParams({
    ...
    params[9] = InterestRatesStrategyParams({
    ...
    params[10] = InterestRatesStrategyParams({
    ...
    params[11] = InterestRatesStrategyParams({
    ...
    params[12] = InterestRatesStrategyParams({
    ...
    params[13] = InterestRatesStrategyParams({
    ...
    params[14] = InterestRatesStrategyParams({
    ...
    params[15] = InterestRatesStrategyParams({
    ...
    params[16] = InterestRatesStrategyParams({
    ...
    params[17] = InterestRatesStrategyParams({
